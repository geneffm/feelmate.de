...
export default function App() {
  ...
  return (
    <main className="font-sans text-gray-900">
      ...
      {/* PREISE (Platzhalter – seriös & knapp) */}
          ...
          {[
            ...
            <div key={i} className="p-6 rounded-3xl border border-gray-200 bg-white shadow-soft flex gap-4">
              <div className="shrink-0">
                <img
                  src={`/images/reviews/avatar${i + 1}.jpg`}
                  alt=""
                  className="w-12 h-12 rounded-full object-cover border border-gray-200"
                  onError={(e) => {
                    e.currentTarget.style.display = "none";
                    const span = document.getElementById(`rv-${i}`);
                ...
                <span
                  id={`rv-${i}`}
                  style={{ display: "none" }}
                  className="w-12 h-12 rounded-full bg-gray-200 text-gray-600 text-sm font-medium items-center justify-center"
                >
