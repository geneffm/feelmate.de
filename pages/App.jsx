...
export default function App(){
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-brand-50 via-white to-white text-gray-900">
      ...
      {/* Hero with curated image (no glasses) */}
      <section className="relative">
        <div className="absolute inset-0 -z-10">
          <!-- Tasteful warm portrait: replace with your final asset later -->
          <img src="https://picsum.photos/seed/warm-portrait-2/1600/900" alt="Stilvolles Portrait" className="w-full h-full object-cover object-center opacity-85" />
      ...
      {/* Image collage: varied age & settings (tasteful, slightly alluring but classy) */}
      <section id="bilder" className="max-w-6xl mx-auto px-4 py-10">
        <div className="grid md:grid-cols-3 gap-4">
          <img src="https://picsum.photos/seed/cafe-portrait/800/600" alt="Café – nahbar & freundlich" className="rounded-2xl object-cover w-full h-64 md:h-56" />
          <img src="https://picsum.photos/seed/evening-milf/800/600" alt="Abendsonne – elegant & feminin" className="rounded-2xl object-cover w-full h-64 md:h-56" />
          <img src="https://picsum.photos/seed/indoor-soft/800/600" alt="Indoor – warm & gemütlich" className="rounded-2xl object-cover w-full h-64 md:h-56" />
        </div>
        <p className="text-xs text-gray-500 mt-2">Hinweis: Symbolbilder – finale Fotos folgen. Stil: warm, respektvoll, stilvoll.</p>
      </section>
